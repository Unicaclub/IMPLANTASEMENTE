...
export class StartPipelineDto {
  ...
  @ApiProperty({ example: 'Discovery inicial do ERP' }) @IsString() title: string;
  @ApiProperty({ example: 'Mapear módulos, APIs e schema' }) @IsString() goal: string;
