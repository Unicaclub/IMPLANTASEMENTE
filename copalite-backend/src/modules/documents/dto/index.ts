import { IsEnum, IsIn, IsOptional, IsString, IsUUID, Length, Matches, MaxLength } from 'class-validator';
...
export class CreateDocumentDto {
  ...
  @ApiPropertyOptional() @IsOptional() @IsString() @MaxLength(50000) contentMarkdown?: string;
}
